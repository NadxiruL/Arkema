                ...
                <div class="p-5">
                  ...
                  <form method="POST" action="processLogin.php" class="user">
                    <div class="form-group">
                      <input type="text" name="username" class="form-control form-control-user" id="username" aria-describedby="emailHelp" ">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="text-center">
                    <a class="small" href="../community/">LOGIN AS COMMUNITY</a>
                  </div>
                  <div class="text-center">
                    <a class="small" href="../collector/">LOGIN AS COLLECTER</a>
                  </div>
                </div>
              </div>
            </div>
