...
<div class="container">
    <h1 class="well">Add Redeem Item</h1>
...
date_default_timezone_set('Asia/Kuala_Lumpur');
						$tarikh = date('dmY');
						$time = date('his');
						$gambar = $tarikh.$time."2.jpg";



	move_uploaded_file($_FILES["pic"]["tmp_name"], "../img/picredeemitem/".$gambar);




$null=null;
$query2=mysqli_query($dbcon ,"INSERT INTO redeemitem VALUES ('$null','$gambar','$des','$point')");
if($query2==true){
		echo ("<script type='text/javascript'>alert('Berjaya');document.location='addredeemitem.php'</script>");

}
else
{
		echo ("<script type='text/javascript'>alert(Gagal');document.location='addredeemitem.php/'</script>");
...
?>
				...
				<form method="POST" enctype="multipart/form-data">
					<div class="col-sm-12">
						<div class="row">
								...
								<input type="text" name="des" placeholder="Description" required class="form-control">
							</div>
								<div class="col-sm-6 form-group">
								<label>Point</label>
		...
		<div class="col-lg-12 well">
	<div class="row">
	   <h1 class="well">List of Redeem Item</h1>
		<table class="table">
		<tr>
		<th>Num.</th>
		<th>Picture</th>
		...
		<tr>
		<td><?PHP echo $num++;?></td>
		<td><img src="../img/picredeemitem/<?PHP echo $jhs['pic'];?>" width="30%"></td>
